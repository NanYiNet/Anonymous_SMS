...
INSERT INTO `admin` (`id`, `adminname`, `password`, `qq`, `email`, `loginip`, `logincity`, `logintime`, `date`, `status`) VALUES
(1, 'admin', '$2y$10$plq.TGQ5BnvG.KJZAmMLXe.qIcg85DvE/78EbQAb2VWUMyn5xOpBe', '2322796106', '2322796106@qq.com', '127.0.0.1', NULL, NULL, '2022-08-01 00:00:00', '1');
...
CREATE TABLE `card` (
  ...
  `usetime` varchar(255) DEFAULT '未使用',
  `status` char(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `config` (
  ...
  `webwx` varchar(255) DEFAULT NULL,
...
INSERT INTO `link` (`id`, `name`, `url`, `img`, `date`, `status`) VALUES
(1, '南逸博客', 'www.nanyinet.com', 'http://auth.nanyinet.com/logo.png', '2022-08-01 00:00:00', '1');
...
CREATE TABLE `order` (
  ...
  `ali_pay` varchar(255) DEFAULT NULL,
