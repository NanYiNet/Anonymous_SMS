...
namespace f2fpay\service;

require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . './../AopSdk.php';

use f2fpay\model\result\AlipayF2FPayResult;
use f2fpay\model\result\AlipayF2FQueryResult;
use f2fpay\model\builder\AlipayTradePrecreateRequest;
use f2fpay\model\builder\AopClient;
use f2fpay\model\builder\SignData;
use f2fpay\model\result\AlipayF2FPrecreateResult;
use f2fpay\model\builder\AlipayTradeQueryRequest;
use f2fpay\model\builder\AlipayTradeQueryContentBuilder;
use f2fpay\model\builder\AlipayTradeCancelContentBuilder;
...
class AlipayTradeService
{
	...
	function __construct($alipay_config)
	{
		...
		$this->appid = $alipay_config['alipay_app_id'];
		$this->sign_type = $alipay_config['sign_type'];
		//$this->private_key = $alipay_config['private_key_file'];
