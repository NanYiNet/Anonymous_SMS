<?php
namespace f2fpay\model\builder;
    ...
    */
    public function pageExecute($request,$httpmethod = "POST") {
        ...
        if (method_exists($request,"getNeedEncrypt") &&$request->getNeedEncrypt()){
            ...
            // 执行加密
            $enCryptContent = Nathan::encrypt($apiParams['biz_content'], $this->encryptKey);
    ...
    function subCNchar($str, $start, $length, $charset) {
    ...
    private function encryptJSONSignSource($request, $responseContent) {
        ...
        $bizContent = Nathan::decrypt($parsetItem->encryptContent, $this->encryptKey);
